...
z80 : src/main.o src/memory.o src/cpu.o src/8-bit_load_groups.o src/16-bit_load_group.o \
        ...
        src/16-bit_arithmetic_group.o src/jump_group.o src/call_and_return_group.o src/IO_group.o src/romloader.o  	
	${CXX} ${CXXFLAGS} ${LDFLAGS} ${TARGET} src/main.o src/memory.o src/cpu.o \
	       	...
	       	src/16-bit_arithmetic_group.o src/jump_group.o src/call_and_return_group.o \
	       	src/IO_group.o src/romloader.o
