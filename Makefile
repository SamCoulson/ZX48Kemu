...
z80 : src/main.o src/romloader.o src/memory.o src/cpu.o src/8-bit_load_group.o src/GPA_and_CPU_control_group.o \
	...
	src/call_and_return_group.o src/rotate_and_shift_group.o src/ula.o src/screen.o src/keyboard.o src/disassembler.o 
	${CC} ${CFLAGS} ${LDFLAGS} ${TARGET} src/main.o src/romloader.o src/memory.o src/cpu.o src/8-bit_load_group.o \
		...
		src/screen.o src/keyboard.o src/disassembler.o -L./lib -L./raylib/lib -lraylib -lGL -lm -lpthread -ldl -lrt -lX11
clean:
	-rm $(SDIR)/*.o
	-rm z80
