...
z80 : src/main.o src/memory.o src/cpu.o src/8-bit_load_groups.o src/16-bit_load_group.o \
       	src/EBTS_group.o src/8-bit_arithmetic_group.o src/GPA_and_CPU_control_group.o src/romloader.o  	
	${CXX} ${CXXFLAGS} ${LDFLAGS} ${TARGET} src/main.o src/memory.o src/cpu.o src/8-bit_load_groups.o \
		src/16-bit_load_group.o src/EBTS_group.cpp src/GPA_and_CPU_control_group.o src/romloader.o
