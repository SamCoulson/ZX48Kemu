...
void execute(uint8_t *opcode)
{
    ...
    if (*opcode == 0xCB || *opcode == 0xDD || *opcode == 0xED ||
        *opcode == 0xFD)
    {
        printf("executing multi byte opcode\n");
