...
// The keyboard can be directly accessed by the Z80 cpu, by way of the
// upper-half of the 8-15 bits of the address bus.  When it does this, a
// specific row of the 8 posible rows will be specified, the readKeyboard
// routine sets the appropriate bits corresponding to keys pressed and passes
// back the requested byte (row).
//
...
// the important thing is that all it does is acts as keybaord unit out side of
// the CPU.
void readKeyboard()
{
