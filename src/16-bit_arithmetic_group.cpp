...
void CPU::ADD16BitRegToHL( uint8_t &HOreg, uint8_t &LOreg ){
...
void CPU::SBC16BitRegToHL( uint8_t &HOreg, uint8_t &LOreg ){
...
void CPU::INC16BitReg( uint8_t &HOreg, uint8_t &LOreg ){
