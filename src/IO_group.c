...
// IN r,(C)
// IO ported is selected through contents of register C which selects one of 256
// ports, register B forms the second part a byte copied from that IO device
// address in to register r
//
// NOTE: ** Although the instruction in the manual does not give it away
// register B is also important here ** 	    as it can be used to address
// locations within the port specified in C.
//
